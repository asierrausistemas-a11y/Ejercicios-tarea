...
#Saludo y tamaños de café a ofrecer:
def mostrar_bienvenida():
    print("------------------------")
    print("BIENVENIDO A COFFEE SHOP")
    print("------------------------")
...
#se le pregunta al usuario que tamaño desea:
def elegir_tamaño():
    tamaño = input("¿Qué tamaño desea? (P/M/G): ").upper() #upper es para evitar errores de escritura del usuario.
    return tamaño
...
def calcular_precio(letra_tamano):
    if letra_tamano == "P":
        ...
        precio = 0  # por si el usuario escribe algo raro

    total = precio * 1.10  # suma 10% de impuesto
    return total

#se confirma que el pedido esté listo: 
def preparar_pedido(letra_tamano, total):
    print(f"Preparando su café {letra_tamano}...")
...
tamaño = elegir_tamaño()

precio_final = calcular_precio(tamaño)

preparar_pedido(tamaño, precio_final)
